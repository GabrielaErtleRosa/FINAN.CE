...
class Categoria (models.Model):
    ...
    def total_gasto(self,):
        ...
        #trazendo tds os valores da categoria escolhida, da data atual e q sejam só de saída!
    ...
    def calcula_percentual_gasto_por_categoria(self):
        ...
        try: #converter pra inteiro pq a progressBar nao aceita float
            return int((self.total_gasto() * 100) / self.valor_planejamento)
        except:
            return 0
        #falta fazer barra total!!
